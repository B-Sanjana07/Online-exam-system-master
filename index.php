...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="capt.jpeg" alt="PRASANTH" width="400" height="300">
        <p><strong>CHERUKUMUDI VENKATA SAI KUMAR</strong></p>
        <p>SJBIT 3rd year BTECH</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="san.jpg" alt="VIJAY" width="400" height="300">
        <p><strong>B SANJANA</strong></p>
        <p>SJBIT 3rd year BTECH</p>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 7795924402 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> sanajanaB@gmail.com</p>
    </div>
